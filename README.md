...
while yhp > 0:
    ...
    if gold == 0 and potion == 0 and action == "inv":        # checks if you actually have items to look at
        while action == "inv":
        ...
        if action == "inv":
            while action == "inv":
                print("\nyou have:\n", gold, "gold coins\n", potion, "potions")
                action = input("What would you like to do? " + str(menulist))
                while action != "back" and action != "drink":           # ok so this is checking to see if you said drink or bakc
                    print("\nInvalid input, Please try again!")
                    action = input("What would you like to do? " + str(menulist))
                    if potion == 0 and action == "drink":
                        print("\nYou have no potions to drink!!")                 # if you said drink but have no potions
                        action = input("What would you like to do? " + str(menulist))

                    if potion > 0 and action == "drink":
                        print("You drink 1 potion\t\t\t\t\t-1 potion")
                        potion = potion - 1                                       # subtracts one potion if you said drink
                        action = input("What would you like to do? " + str(menulist))
                        while action != "back" and action != "drink":
    ...
    while ghp > 0 and action == "atk" and yhp > 0:  # loop runs if either are alive, atk and inv work
            ...
            if crt >= 85:  # checking for crt
                ...
                if ghp <= 0:
                    ...
                    if yhp <= 0:
                        ...
                        print("You died with", potion, "unused potion(s)!")
                    else:
        ...
        if action == "run":
            ...
            print("You ran off with", potion, "unused potion(s)!")
